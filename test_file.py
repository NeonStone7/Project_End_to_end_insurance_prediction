...
# experiment_id = set_or_create_mlflow_experiment(experiment_name, model_artifact_path)
...
# model_uri = f"{mlflow_tracking_uri}/0/968762672263383880/{latest_run.run_id}/artifacts"
